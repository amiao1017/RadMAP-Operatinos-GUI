    ...
    if dbSocket.poll(1) != 0:
    	...
    	if dbCommand == 'startHyperSpec':
    	    ...
    	    if HyperSpecAcqStarted == False: #run HyperSpecAcq and verify
                ...
                iAcquisition = subprocess.Popen("E:\\ResononAPI_2.2_Beta\\bin\\2iHyperSpecAcquisitionV2.6.exe >> E:\\HS_Data\\hs2i.txt", cwd=r'E:\\HS_Data\\', creationflags=subprocess.CREATE_NEW_CONSOLE)
